...
import 'package:inventory_client/controllers/inventory/edit_inventory_controller.dart';
// ignore: depend_on_referenced_packages
import 'package:path/path.dart' as path;

pickMultileFiles(
    BuildContext context, EditInventoryScreenController controller) async {
...
Future<String?> pickImage(
    EditInventoryScreenController controller, ImageSource imageSource) async {
  try {
...
Future<List> getImageBottomSheet(
    EditInventoryScreenController controller) async {
