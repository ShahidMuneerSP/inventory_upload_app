...
pickMultileFiles(
    BuildContext context, EditSaleScreenController controller) async {
...
Future<String?> pickImage(
    EditSaleScreenController controller, ImageSource imageSource) async {
  try {
...
Future<List> getImageBottomSheet(EditSaleScreenController controller) async {
