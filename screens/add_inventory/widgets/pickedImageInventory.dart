...
pickMultileFiles(
    BuildContext context, AddEditInventoryScreenController controller) async {
...
Future<String?> pickImage(AddEditInventoryScreenController controller,
...
Future<List> getImageBottomSheet(
    AddEditInventoryScreenController controller) async {
