...
pickMultileFiles(
    BuildContext context, AddEditSaleScreenController controller) async {
...
Future<String?> pickImage(
    AddEditSaleScreenController controller, ImageSource imageSource) async {
  try {
...
Future<List> getImageBottomSheet(AddEditSaleScreenController controller) async {
