...
pickMultileFiles(
    BuildContext context, AddEditPurchaseScreenController controller) async {
...
Future<String?> pickImage(
    AddEditPurchaseScreenController controller, ImageSource imageSource) async {
  try {
...
Future<List> getImageBottomSheet(
    AddEditPurchaseScreenController controller) async {
