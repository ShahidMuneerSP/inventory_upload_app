...
import 'package:inventory_client/apis/purchase/delete_purchasefile_api.dart';
import 'package:inventory_client/controllers/purchase/edit_purchase_controller.dart';
import 'package:inventory_client/models/purchase_model.dart';
import 'package:inventory_client/screens/edit_purchase/widgets/pickedImageEditPurchase.dart';
import 'package:inventory_client/screens/sales/view_models/url_to_file.dart';
import '../../apis/purchase/update_purchase_api.dart';
...
class EditPurchaseScreen extends StatefulWidget {
  ...
  final List<PurchaseFile> dataModel;
...
class _EditPurchaseScreenState extends State<EditPurchaseScreen> {
  ...
  EditPurchaseScreenController editPurchaseScreenController =
      EditPurchaseScreenController();
  ...
  void initState() {
    super.initState();
    final value = purchaseScreenController.data[widget.index];
  ...
  getFileData() {
    ...
    widget.data.purchaseFile?.forEach((element) {
    ...
    newValue.forEach((element) async {
      ...
      editPurchaseScreenController.pickedUrlPathModel.add(PickedFilePathModel(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            customAppBarWidget("Edit Purchase"),
            Expanded(
                              ...
                              editPurchaseScreenController
                                  ...
                                  : Container(
                                      ...
                                      child: ListView.separated(
                                        physics: const BouncingScrollPhysics(),
                                        itemCount: editPurchaseScreenController
                                                        ...
                                                        return AlertDialog(
                                                          ...
                                                          actions: [
                                                            TextButton(
                                                                onPressed:
                                                                    () async {
                                                                  bool data = await deletePurchaseFileApi(widget
                                                                          .dataModel[
                                                                              index]
                                                                          .id ??
                                                                      "");
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                log(editPurchaseScreenController
                                    .pickedFilePathModel.value
                                    .toString());

                                bool updateData = await updatePurchaseApi(
                                    PurchaseId: purchaseScreenController
                                    ...
                                    images: editPurchaseScreenController
                                        .pickedFilePathModel.value);
...
class UploadFileWidget extends StatelessWidget {
  EditPurchaseScreenController editPurchaseScreenController;
  UploadFileWidget({Key? key, required this.editPurchaseScreenController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          await getImageBottomSheet(editPurchaseScreenController);
        },
        child: Container(
          decoration: BoxDecoration(
            boxShadow: [
